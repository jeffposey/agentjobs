...
Model **`claude-opus-5`** | Claude Code `2.1.238` | bundle at commit `5365d58` | runs per arm: 3

7 scenario(s), 42 session(s), $30.34, 17.4 min wall clock (50.5 min of session time).
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.71; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.76; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.67; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.61; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.90; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.85; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $3.45; 2 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $4.32; 2 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $2.18; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $2.21; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.68; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.74; 0 sandbox-guard denial(s)
- ablated: 10 line(s), section(s) none
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $2.15; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $2.11; 0 sandbox-guard denial(s)
- ablated: 129 line(s), section(s) ['ENGINEERING.md#Sharing a clone', 'ALLAGENTS.md#Why you get your own worktree', 'AGENTS.md#Branch and Worktree Lifecycle']
