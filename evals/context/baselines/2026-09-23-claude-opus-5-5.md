...
Model **`claude-opus-5-5`** | effort: model default | Claude Code `2.1.280` | bundle at commit `f341297e` | runs per arm: 3

6 scenario(s), 36 session(s), $12.99, 12.6 min wall clock (34.6 min of session time).
...
| `worktree-interpreter`   | ALLAGENTS.md#Bootstrapping a worktree (the interpreter paragraphs)            | 100% | 0%      | **load_bearing** |
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $0.99; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $0.98; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.09; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.14; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $0.95; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $0.95; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.50; 2 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.41; 3 sandbox-guard denial(s)
- ablated: 129 line(s), section(s) ['ENGINEERING.md#The Merge Gate']

### `worktree-interpreter`: load_bearing
...
**Result.** 100% compliant with the rule, 0% without -- removing it changed what the agent did

- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $0.93; 0 sandbox-guard denial(s)
- `without`: 0 compliant, 3 violating, 0 inconclusive, 0 errored of 3 run(s); $1.07; 0 sandbox-guard denial(s)
...
- `with`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $1.01; 0 sandbox-guard denial(s)
- `without`: 3 compliant, 0 violating, 0 inconclusive, 0 errored of 3 run(s); $0.98; 0 sandbox-guard denial(s)
- ablated: 108 line(s), section(s) ['ALLAGENTS.md#Why you get your own worktree', 'AGENTS.md#Branch and Worktree Lifecycle', 'ENGINEERING.md#Sharing a clone']
