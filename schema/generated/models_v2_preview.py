...
linkml_meta = LinkMLMeta({'default_prefix': 'aj',
     ...
     'description': 'The task schema AgentJobs uses. Transcribed from '
                    'docs/schema-design.md (ACCEPTED, D1-D3 resolved 2026-07-29) '
                    'into LinkML so it can be rendered, browsed, validated and '
                    'diffed.\n'
                    'This is DESCRIPTIVE, not prescriptive: v2 shipped under '
                    'task-050 and every record in the live corpus is a v2 record. '
                    'The authority on runtime behaviour is '
                    'src/agentjobs/models_v2.py, which enforces six consistency '
                    'rules; this file encodes the first four of them, because '
                    'LinkML cannot express the other two. Section references below '
                    'point at docs/schema-design.md.\n'
                    '(Until 2026-08-22 this description read "PRESCRIPTIVE: '
                    'nothing here is implemented yet ... the intended input to '
                    'task-050", and it was carried verbatim onto every generated '
                    'reference page.)\n'
